...
# Lokale Modulimporte
from config import (
    DEFAULT_PREPROCESS_THREADS, WHISPER_MODEL_OPTIONS, BASE_OUTPUT_DIR, MIN_SEGMENT_SEC, MAX_SEGMENT_SEC, MIN_DBFS, MIN_SNR_DB, MERGE_THRESHOLD, PROSODY_PITCH_WEIGHT, PROSODY_ENERGY_WEIGHT
)
